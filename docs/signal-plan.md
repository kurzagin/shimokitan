...
## 4. Implementation Stages (Proposed)

1.  **Phase I (Data Foundation):** 
    - Apply Drizzle migrations for expanded enums and interaction tables.
    - Synchronize seed data with the new structure.

2.  **Phase II (The Factory):**
    - Build the composition interface in `apps/dashboard`.
    - Enable R2 multi-attachment support.

3.  **Phase III (The Broadcast):**
    - Replace `apps/signal` landing page with the dynamic Bento Magazine.
    - Integrate real-time "Resonance" tracking.

4.  **Phase IV (Resident Voice):**
    - Enable Neon Auth gated comments and reactions.
    - Build the "Argument Spectrum" visualizer.
