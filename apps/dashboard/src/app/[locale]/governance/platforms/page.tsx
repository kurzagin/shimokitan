    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-12">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-zinc-900 pb-12">
                ...
                <Suspense fallback={<div className="w-40 h-10 bg-zinc-900 animate-pulse rounded" />}>
                    <PlatformDialog 
                        key={editingPlatform?.id || 'new'} 
                        editingPlatform={editingPlatform as any} 
                    />
                </Suspense>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    {platforms.length === 0 && (
                        <div className="md:col-span-2 lg:col-span-3 py-24 border border-dashed border-zinc-900 rounded-xl flex flex-col items-center justify-center gap-4 bg-zinc-950/20">
